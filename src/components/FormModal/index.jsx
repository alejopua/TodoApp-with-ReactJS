    ...
    return (
        <div className="m-5 flex items-center justify-center">
            <div className="w-96 h-[660px] p-4 bg-[#acd9e6] flex flex-col items-start gap-5 rounded-md border-2 border-solid border-black shadow-[4px_4px_black] ">
                ...
                <div className="text-[#323232] font-black text-xl">Thank you for using TodoApp,<br /><span className="text-[#666] font-semibold text-[17px]">This app was built</span></div>
            </div>
        </div>
    )
}
